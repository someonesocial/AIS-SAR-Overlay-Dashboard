...
taskkill /FI "WINDOWTITLE eq Eye of God*" /T /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq npm*" /T /F >nul 2>&1
for /f %%P in ('powershell -NoProfile -Command "Get-NetTCPConnection -LocalPort 3001,5173 -State Listen -ErrorAction SilentlyContinue | Select-Object -ExpandProperty OwningProcess -Unique"') do taskkill /PID %%P /F >nul 2>&1
